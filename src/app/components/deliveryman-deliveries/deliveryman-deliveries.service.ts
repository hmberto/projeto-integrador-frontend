...
export class DeliverymanService {
  ...
  getNewOrders(deliveryman: Deliveryman) {
    ...
    const url = "https://projeto-integrador-myorder.herokuapp.com/delivery/orders/my/" + deliveryman.id + "/14";
  ...
  closeDelivery(order) {
    ...
    const url = "https://projeto-integrador-myorder.herokuapp.com/delivery/order/" + deliverymanId + "/" + orderId + "/24";
